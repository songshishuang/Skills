...
按 13 节标准结构产出 AI 产品 PRD。结构源自宋世双 V0.5 实际使用版本（4 节简洁结构：版本说明 / 文档记录 / 需求范围 / 需求设计），补齐 AI 产品 6 大缺口：**业务目标、用户故事、数据埋点、评测指标、灰度上线、验收清单**。
...
若 Stage 1 第 5 题答 **是**，对每个 AI 子功能在第六节追加 6 个特化小节：
...
- [ ] 涉及 AI 模块 → 第六节有 6 个特化小节（模型/提示词/KB/工具/兜底/可观测）
