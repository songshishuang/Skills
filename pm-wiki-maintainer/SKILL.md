...
│    ├── decisions/ADR-XXX.md   从 PRD §7.2 抽出关键决策（prd-writer v2.3 7 节结构）│
...
- [ ] **frontmatter 字段裁剪**：wiki-structure.md 强制 6 个 frontmatter 字段（type / created / updated / sources / related / status），实际有几个真被填了？没填的降到「推荐」
